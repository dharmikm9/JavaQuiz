				...
				<div class="row">
					<div class="col-md-8">
						...
						Lorem Ipsum is inting and typesetting in simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the is dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
                                                ...
                                                <form class="form-light mt-20" role="form" method="post" action="ContactServlet">
							...
							<div class="form-group">
								<label>Message</label>
								<textarea class="form-control" name="message" id="message" required="" placeholder="Write you message here..." style="height:100px;"></textarea>
							</div>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="contact-info">
									<h5>Address</h5>
									<p>Sarvodaya Nagar,Joshipura - Junagadh.</p>
									
									<h5>Email</h5>
									<p>dj1998@gmail.com</p>
